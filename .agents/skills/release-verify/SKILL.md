...
1. Read **docs/standards/workspace-management.md**, **docs/standards/release-versioning.md**, **docs/standards/testing.md**, and **docs/standards/definition-of-done.md** completely.
...
6. Check blocking defects, waivers, dependencies, code-freeze exceptions, known issues, and owner sign-offs.
...
9. After explicit evidence confirms formal release, set the release status to released, fill released_at, update each actually shipped requirement to released, fill released_in, and synchronize both indexes.
10. Report unmet gates, exceptions, final decision, and every state change made.
...
- Do not invent sign-offs or operational evidence.
