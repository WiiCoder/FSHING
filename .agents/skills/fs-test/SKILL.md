...
6. Refresh affected workspace lock entries from actual Git state after test-related commits.
7. Report passed, failed, blocked, not-applicable, coverage gaps, invalidated evidence, and the release-readiness decision.
