...
| ready | 当前 Spec 版本已批准，approved_at 已填写 |
...
例外状态不得删除历史目标版本、审批或验证证据。

## 变更对状态的影响

- **次版本 Spec 变化**：根据影响保留当前状态或退回 review；所有受影响测试必须重新评估。
- **主版本 Spec 变化**：必须退回 review，重新批准后才能回到 ready。
